...
def main(interactive_vis=False, vis_figsize=(10, 8), vis_dpi=100, save_path=None,
    ...
    nz = 100  # Number of grids in Z direction (model depth direction grid count)
    ...
    fcct_tri1 = [4, 5, 6]  # Complex thickness distribution
    fcct_tri2 = [5, 6, 7]  # Complex thickness distribution
    fcct_tri3 = [6, 7, 8]  # Complex thickness distribution
    fcct_tri4 = [7, 8, 9]  # Complex thickness distribution
    fcct_tri5 = [8, 9, 10]  # Complex thickness distribution
    ...
    params = {
        ...
        'mxcc': 400,  # Maximum number of channel complexes
        ...
        'fcct': fcct_tri1,  # Complex thickness triangular distribution
        ...
        'fcat': fcct_tri1,  # Channel average thickness triangular distribution
        ...
        'fcawu': [18, 22, 25],  # Channel width control, larger values mean greater width

        # Partition control parameters
        'partition_axis': 'x',  # Partition axis, 'x' or 'y'
        'num_regions': 7,  # Number of partitions
        ...
        'region_configs': {
            0: {  # Region 0 configuration
                ...
                'fcct': fcct_tri2,  # Regional thickness distribution
                'fcat': fcct_tri2,  # Regional channel thickness distribution
