...
def main(interactive_vis=False, vis_figsize=(10, 8), vis_dpi=100, save_path=None,
    ...
    nz = 300  # Number of grids in Z direction (model depth direction grid count)
    ...
    fcct_tri = [5, 7, 9]  # Complex thickness distribution
    ...
    sinuosity_tri = [1.3, 1.4, 1.7]  # Channel sinuosity triangular distribution
    ...
    params = {
        ...
        'mxcc': 250,  # Maximum number of channel complexes
