...
def main(interactive_vis=False, vis_figsize=(10, 8), vis_dpi=100, save_path=None,
    ...
    nx = 350  # Number of grids in X direction (model width direction grid count)
    ny = 350  # Number of grids in Y direction (model length direction grid count)
    nz = 200  # Number of grids in Z direction (model depth direction grid count)
    lx = 3000  # Physical length in X direction (meters)
    ly = 3000  # Physical length in Y direction (meters)
    lz = 100  # Physical thickness in Z direction (meters)
    ...
    fcct_tri = [5, 5, 5]  # Complex thickness distribution
    fccwtr_tri = [1.5, 1.5, 1.5]  # Complex width-to-thickness ratio distribution
    fccntg_tri = [1, 1, 1]  # Complex net-to-gross ratio distribution
    fcco_tri0 = [0, 0, 0]  # Complex orientation angle

    sinuosity_tri = [1.6, 1.71, 1.82]  # Channel sinuosity triangular distribution
    ...
    params = {
        ...
        'mxcc': 1,  # Maximum number of channel complexes
        ...
        'fcawu': [1, 1, 1],  # Channel width control, larger values mean greater width

        # Partition control parameters
        'partition_axis': 'x',  # Partition axis, 'x' or 'y'
        'num_regions': 4,  # Number of partitions
        ...
        'region_configs': {
            0: {  # Region 0 configuration
                ...
                'channel_sinuosity': sinuosity_tri,  # Regional channel sinuosity
        ...
        'enable_migration': True,# Enable channel migration simulation
        'migration_steps':30,# Migration steps
        ...
        'vegetation_update_interval': 10,# Vegetation update interval
        ...
        'levee_enabled': True,# Natural levee enable
        ...
        'crevasse_enabled': True,# Crevasse splay enable
