...
def main(interactive_vis=False, vis_figsize=(10, 8), vis_dpi=100, save_path=None,
    ...
    fcct_tri = [3, 4, 5]  # Complex thickness distribution
    fccwtr_tri =  [2.7, 2.7, 3.71]  # Complex width-to-thickness ratio distribution
    fccntg_tri = [1, 1, 1]  # Complex net-to-gross ratio distribution
    fcco_tri0 = [0, 0, 0]  # Complex orientation angle

    sinuosity_tri = [1.2, 1.4, 1.6]  # Channel sinuosity triangular distribution
    ...
    params = {
        ...
        'width_downstream_trend': 0.2, # Width downstream trend
