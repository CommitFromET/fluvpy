...
def main(interactive_vis=False, vis_figsize=(10, 8), vis_dpi=100, save_path=None,
    ...
    fcct_tri = [2, 3, 5]  # Complex thickness distribution
    fccwtr_tri = [1.7, 1.7, 1.7]  # Complex width-to-thickness ratio distribution
    fccntg_tri = [1, 1, 1]  # Complex net-to-gross ratio distribution
    fcco_tri0 = [0, 0, 0]  # Complex orientation angle

    sinuosity_tri1 = [1.1, 1.2, 1.3]  # Channel sinuosity triangular distribution
    sinuosity_tri2 = [1.4, 1.5, 1.6]  # Channel sinuosity triangular distribution
    sinuosity_tri3 = [1.1, 1.2, 1.3]  # Channel sinuosity triangular distribution
   ...
   # base_seed = 89769  # Base seed
    ...
    params = {
        ...
        'mxcc': 200,  # Maximum number of channel complexes
        ...
        'channel_sinuosity': sinuosity_tri1,# Channel sinuosity control parameter
        ...
        'region_configs': {
            0: {  # Region 0 configuration
                ...
                'channel_sinuosity': sinuosity_tri1,  # Regional channel sinuosity
            ...
            1: {  # Region 1
                ...
                'fcct': fcct_tri,
                'fcat': fcct_tri,
                'channel_sinuosity': sinuosity_tri2,
            ...
            2: {  # Region 2
                ...
                'fcct': fcct_tri,
                'fcat': fcct_tri,
                'channel_sinuosity': sinuosity_tri3,
                'z_distribution_params': {
                    'z_distribution_mode': 'custom',
                    'z_num_strata': 6,
                    'z_custom_weights': [1, 1, 1, 1, 1, 1]
