...
def main(interactive_vis=False, vis_figsize=(10, 8), vis_dpi=100, save_path=None,
    ...
    nx = 300  # Number of grids in X direction (model width direction grid count)
    ny = 300  # Number of grids in Y direction (model length direction grid count)
    nz = 150  # Number of grids in Z direction (model depth direction grid count)
    ...
    fcct_tri = [4, 5, 6]   # Complex thickness distribution

    fccwtr_tri = [1.7, 1.7, 1.71]  # Complex width-to-thickness ratio distribution
    fccntg_tri = [1, 1, 1]  # Complex net-to-gross ratio distribution
    fcco_tri0 = [-30, 0, 30]  # Complex orientation angle

    sinuosity_tri = [1.4, 1.6, 1.8]  # Channel sinuosity triangular distribution
    ...
    params = {
        ...
        'mxcc': 300,  # Maximum number of channel complexes
        ...
        'fcawu': [8, 9, 13],  # Channel width control, larger values mean greater width
        ...
        'region_configs': {
            0: {  # Region 0 configuration
                'density_factor': 0,  # Density factor
        ...
        'enable_river_trends': True,# Enable river trend control
